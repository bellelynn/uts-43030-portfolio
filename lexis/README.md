...
3. Client and lawyer management — full CRUD with role-based access control enforced at the SQL level (see Goal 1 for details)
...
│                          │ ◄───────────────│       REST API           │
│   - Ant Design 6         │     Axios       │                          │
│   - ECharts (dashboard)  │                 │   - JWT auth middleware  │
│   - React Router DOM v7  │                 │   - Body-size + content- │
│   - useState / Context   │                 │     type validation      │
│                          │                 │   - Per-IP rate limit    │
│                          │                 │   - RBAC in SQL queries  │
└──────────────────────────┘                 └────────────┬─────────────┘
                                                          │ pg driver
...
Source code
🔗 Repository: github.com/bellelynn/case-management
...
Challenges overcome (from the repository README)
